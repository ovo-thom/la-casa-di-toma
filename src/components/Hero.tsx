    ...
    >
      <div className="relative w-full">
        <motion.div
          ...
          viewport={{ once: true }}
          className="absolute inset-0 bg-gradient-to-br from-black/70 via-black/50 to-[#9a3737]/20 rounded-xl"
        >
          <div className="flex flex-col justify-center items-center h-full px-4 md:px-6 lg:px-8 py-8 md:py-12 lg:py-16">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-6 md:mt-6 lg:mt-8 bg-[#9a3737] hover:bg-[#7d2d2d] text-white px-4 sm:px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold text-sm sm:text-base md:text-lg transition-all duration-300 shadow-xl hover:shadow-2xl transform"
            >
