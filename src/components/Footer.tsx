      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="text-sm mb-2">
            Restaurant italien artisanal à votre service
          </p>
          <p className="text-xs text-[#f3e9dc]">
            © {new Date().getFullYear()} La Casa di Toma. Tous droits réservés.
          </p>
        </div>
        <div className="flex flex-col items-center gap-2">
          <span className="font-semibold">Contact</span>
          <a href="tel:+33123456789" className="hover:underline text-[#f3e9dc]">
            01 23 45 67 89
          </a>
          <a
            href="mailto:contact@lacasaditoma.fr"
            className="hover:underline text-[#f3e9dc]"
          >
            contact@lacasaditoma.fr
          </a>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex gap-3">
            <a
              ...
              className="hover:text-[#f3e9dc] transition"
            >
              <svg
                width="24"
                height="24"
